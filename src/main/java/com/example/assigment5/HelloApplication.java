...
// Coded by Abuty Limpho Namanyane ...............................
public class HelloApplication extends Application {

    VBox label22 = new VBox();
    ...
    String source = getClass().getResource("/plane1.png").toExternalForm();
    ...
    public void start(Stage stage) {
      ...
      //Desplaying the score of the Game.................***********............
        Pane root = new Pane();
       ...
       // nka lipoints ka ho nka chelete
        ...
        final Group group = new Group(createInstructions(),createScore(),label22,shape_2,shape_3,shape_4,shape2,shape3,shape4,shape5,root);
        ...
        stage.setTitle("THIS IS A GAME AND ENJOY PLEASE!!!!!");
    ...
    public void Play(){
        seq1.play(); seq2.play();
        seq3.play(); seq4.play();
        seqT1.play(); seqT2.play();
        seqT2.play(); seqT3.play();
        seqT4.play(); seqT5.play();
    }
    public void Pause(){
        seq1.pause();
        seq2.pause();
...
//    }
    private Label createInstructions() {
        ...
        instructions.setFont(Font.font("Tahoma", FontWeight.NORMAL,15.5));
        return instructions;
    }
    private Label createScore() {
        ...
        label22.getChildren().add(labelScore);

        labelScore.setTextFill(Color.TEAL);
        labelScore.setFont(Font.font("Tahoma", FontWeight.BOLD,17.5));
        ...
        shape_1.translateXProperty().addListener(new ChangeListener<Number>() {
            ...
            public void changed(ObservableValue<? extends Number> observableValue, Number number, Number t1) {
                if (shape1.getBoundsInParent().intersects(shape_1.getBoundsInParent())){
                    String icon= getClass().getResource("/fire.png").toExternalForm();
